...
<head>
  ...
  <title>SKILLX LMS admin Login</title>
  ...
  .login-img3-body{
	  background-image: url("<?php echo base_url();?>assets/img/photo-1551731409-43eb3e517a1a.jpg"); 
...
<body class="login-img3-body">
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
     <!-- Uncomment below if you prefer to use an image logo -->
       <a href="<?= base_url(); ?>" class="logo1 mr-auto"><img src="<?= base_url(); ?>assets/img/SkillX_final.png" style="width: 140px;" alt="" class="img-fluid"></a>
  ...
  <div class="container">
    ...
    <form class="login-form" action="<?= base_url();?>Home/companylogindo" method="post">
      <?php if($error1 = $this->session->flashdata('msg1')){ ?>
                           <strong><p style="color: red;"><?php echo  $error1; ?><p></strong>
                           <?php } ?>
						   <?php $flash=$this->session->flashdata('signal');
						   echo $flash;
	  ...
	  <center><h2><b>ADMIN LOGIN</b></h2></center>
        ...
        <a href="<?php echo base_url();?>Home/companysignup"class="btn btn-info btn-lg btn-block" >New Company Signup</a>
      </div>
    </form>
    <div class="text-right">
      <div class="credits">
          Designed by <a href="https://tridentdigitech.com/">Trident Digitech Services</a>
        </div>
    </div>
  </div>
