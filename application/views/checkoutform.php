...
<body>
	...
	<center>
<img class="card-img-top" src="<?php echo base_url(); ?>assets/img/SkillX_final.png" style="width: 200px; height: 100px;" alt="Card image cap">
  </center>
  <div class="card-body">
    <h5 class="card-title">Checkout</h5>
    <p class="card-text">Item Name: <?php echo $bb->course_name; ?></p>
	<p class="card-text">Item Description: <?php echo $bb->description; ?></p>
    <p class="card-text">Price: Rs.<?php echo $bb->course_price; ?></p>
    
  </div>

</div>
<?php $i=0;?>
	<form method="POST" name="customerData" action="<?php echo base_url();?>Home/ccavRequestHandler">
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b></b></font></caption></table>
			<table width="50%" height="100" border='1' align="center">
				...
				<tr>
					<td><input type="hidden" name="merchant_id" value="274612"/></td>
				</tr>
				<tr>
					<td>Order Id	:</td><td><input type="text" name="order_id" value="<?php echo "tdsx/".date("Y")."/".$id[0]['COUNT(*)'];?>" readonly /></td>
				</tr>
				<tr>
					<td>Amount	:</td><td><input type="text"  name="amount" value="<?php echo $bb->course_price; ?>" readonly /></td>
				</tr>
				<tr>
					<td><input type="hidden" name="currency" value="INR" readonly /></td>
				</tr>
				<tr>
					<td><input type="hidden" name="redirect_url" value="<?php echo base_url();?>Home/response"/></td>
				</tr>
			 	<tr>
			 		<td><input type="hidden" name="cancel_url" value="<?php echo base_url();?>Home/response"/></td>
			 	</tr>
			 	<tr>
		        ...
		        <tr>
		        	<td>Enter Student Name	:</td><td><input type="text" name="name"  value="" required /></td>
		        </tr>
			
		        <tr>
		        	<td>Enter Student City	:</td><td><input type="text" name="city" value="" required /></td>
		        </tr>
		        <tr>
		        	<td>Enter Student State	:</td><td><input type="text" name="state" value="" required /></td>
		        </tr>
		        <tr>
		        	<td>Enter Student Zip	:</td><td><input type="text" name="zip" value="" required /></td>
		        </tr>
		        <tr>
		        	<td>Enter Student Country	:</td><td><input type="text" name="country" value="" required /></td>
		        </tr>
		        <tr>
		        	<td>Enter Student Phone No:</td><td><input type="text" name="phone" value="" required /></td>
		        </tr>
		        <tr>
		        	<td>Enter Student Email	:</td><td><input type="email" name="email" value="" required /></td>
		        </tr>
				
				 <tr>
		        	<td>Course_id:</td><td><input type="text" name="course"  value="<?php echo $bb->course_id; ?>" readonly required /></td>
		        </tr>
				
				 <tr>
		        	<td>Purchasing Date:</td><td><input type="text" name="date"  value="<?php echo date("d/m/Y"); ?>" readonly required /></td>
		        </tr>
		       
		        <tr>
		        	<td></td><td><INPUT TYPE="submit" class="btn-primary" value="CheckOut"></td>
		        </tr>
	      	</table>
	      </form>
