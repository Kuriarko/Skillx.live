...
<article class="card-body mx-auto" style="max-width: 400px;">
  ...
  <form method="post" action="<?= base_url(); ?>Home/companysignupdo" enctype="multipart/form-data">
    ...
    <div class="form-group input-group">
      ...
      <input class="form-control" placeholder="Create password" name="password" id="password" minlength="5" type="password" required ><span><i class="fa fa-eye" id="eye"></i></span>
    </div> <!-- form-group// -->  
	...
	<label>Company Logo</label>
	 <div class="form-group input-group">
      ...
      <div class="input-group-prepend">
        <span class="input-group-text"><i class="fa fa-address-card"></i>Logo</span>
      </div>
	  
       <input class="form-control" type = "file" name = "userfile"  palceholder="upload Logo" required />
    </div>
	<!-- form-group// --> 
   ...
   <!-- form-group// -->                                   
    ...
    <p class="text-center">Have an account? <a href="<?= base_url(); ?>Home/adminlogin">Log In</a> </p>                                                                 
</form>
</article>
</div> <!-- card.// -->
          <!--
...
var email = $('#email').val();
  ...
  if(phone!="")
  {
    jQuery.ajax({
    type: "POST",
    url: "<?php echo base_url('/Home/checkUserEmail'); ?>",
    dataType: 'html',
    data: {email: email},
    success: function(res) 
    {
