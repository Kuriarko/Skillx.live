...
<html lang="en">
  ...
  <body>
        <div class="container" style="margin-top: 50px;">
			...
			if($len==0)
			{
				echo "You haven't added any courses yet.";
  ...
  <img class="img-fluid" src="<?php echo base_url(); ?>uploads/courses/<?php echo $row->thumbnail;?>" alt="Card image cap">
    ...
    <a href="<?php echo base_url();?>Home/instructorviewmodule/<?php echo $row->course_id;?>" ><button type="button" style="background-color: #4169E1; color: white; border-color: white; ">View Modules</button></a>
  </div>
</div>
