...
<html>
<head>
        <title>Skill Buyer Registration</title>
...
<section>
 <div class='container' style='padding-top: 25px; padding-bottom: 50px;'>
            ...
            <center>
            <form id='registrationform' name="registrationform" autocomplete="off" method="post" onsubmit="return validateform()" action="<?php echo base_url();?>index.php/Home/sb">

              
     <h2 style='float: left; width: 100%; font-size: 28pt; font-family: oswald, arial; font-weight: normal; word-spacing: 5px;'>Companies Registration</h2>
