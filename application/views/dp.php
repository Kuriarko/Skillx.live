...
<h1 style='display: inline-block; font-size: 24pt; font-family: cabin, oswald, arial; font-weight: normal; color: #444444;'>Profile Picture</h1>
<a class='button' href='#' style='float: right; margin-right: 0px; margin-top: 5px;'><span>Return to profile dashboard</span></a>
</div>
<div style='display: inline-block; width: 100%; padding-top: 5px; padding-bottom: 10px;'>
<p style='float: left; font: 9pt arial; color: #444444;'><a href='#' style='font: inherit; color: inherit; text-decoration: inherit;'>Public Profile</a></p>
...
<div name='includediv' id='includediv' style='float: left; width: 100%;'>
        ...
        <div style='float: left; width: 100%; padding-top: 10px;'>
            ...
            <form style="float: left; width: 100%;" enctype="multipart/form-data" name="updateform" method="post" action="<?php echo base_url();?>Home/do_upload">
...
<input style='display: inline-block; vertical-align: middle; width: 200px; border: 1px solid #AAAAAA; font: 10pt arial;' type='file' id='logo1' name='logo1'><span><input type="submit" style='display: inline-block; vertical-align: middle; margin-left: 10px;' value="upload"></span></div>
