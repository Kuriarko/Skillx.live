...
<section>
    <div id='parentContainerDiv' class='container'>
        ...
        <div id='leftDiv'>
            ...
            <form id='artistLoginForm' name='artistLoginForm' method='post' onsubmit="return validatation()" action="<?php echo base_url();?>index.php/Home/learnlogin">
                ...
                <div style='display: inline-block; width: 100%;'>
                    ...
                    <div style='display: inline-block; width: 100%;'>
                        ...
                        <p>You have entered incorrect email/password: login again</p>
