...
<head>
  ...
  .login-img3-body{
	  background-image: url("<?php echo base_url();?>assets/img/photo-1576485436509-a7d286952b65.jpg"); 
...
<body class="login-img3-body">
  ...
  <div class="container">
    ...
    <form class="login-form" action="<?= base_url();?>Home/instructorlogindo" method="post">
      <?php if($error1 = $this->session->flashdata('msg1')){ ?>
                           <strong><p style="color: red;"><?php echo  $error1; ?><p></strong>
                           <?php } ?>
      <div class="login-wrap">
	  <center><h2><b>INSTRUCTOR LOGIN</b></h2></center>
        ...
        <a href="<?= base_url();?>Home/instructorsignup" class="btn btn-info btn-lg btn-block" type="submit">New Instructor Signup</a>
      </div>
    </form>
