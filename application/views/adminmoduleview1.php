  ...
  <div class="accordion-body js-accordion-body" id="<?php echo $r1->module_id;?>">
    <div class="accordion-body__contents">
	        <?php
                   ...
                   ?>
                            <td>
                              <a href='<?php echo base_url();?>Home/adminfetchcontent/<?php echo $r2->content_id;?>'><h6><?php echo $r2->file_name;?></h6></a>
                            </td>
                            <td>
                        ...
                        ?> 
                            ...
                            <td>
                              <a href='<?php echo base_url();?>Home/adminfetchcontent/<?php echo $r2->content_id;?>'><h6><?php echo $title;?></h6></a>
                            </td>
                            <td>
                              <a class="btn btn-danger" href="<?php echo base_url();?>Home/deletecontent/<?php echo $r2->content_id;?>/<?php echo $r2->course_id;?>"><i class="icon_close_alt2"></i></a>
                            </td>
