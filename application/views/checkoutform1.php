...
<?php $i=0;?>
	<form method="POST" name="customerData" action="<?php echo base_url();?>Home/ccavRequestHandler1">
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b></b></font></caption></table>
			<table width="50%" height="100" border='1' align="center">
				...
				<tr>
		     	...
		     	<tr>
		     		<td colspan="2"><b>New Student Enrollment:</b></td>
		     	</tr>
		        <tr>
				...
				<tr>
		        	<td>Create New Password	:</td><td><input type="password" name="password" value="" required /></td>
		        </tr>
				
				<tr>
		        	<td>Company id:</td><td><input type="text" name="company_id" value="<?php echo $bb->company_id;?>" readonly required /></td>
		        </tr>
