...
<section align="center" class="arrange">
   <div class='container' style='min-height: 500px; padding-top: 40px; padding-bottom: 25px;'>
            ...
            <div style="display: inline-block; width: 95%; min-width: 280px; max-width: 438px;">
                ...
                <p style='display: inline-block; font-size: 40pt; font-family: oswald, arial; color: #444444;'>Professionals Login</p>

                <form id="loginartist" name="loginartist" method="post" onsubmit="return validatation()" action="<?php echo base_url();?>index.php/Home/proflogin" style='display: inline-block; width: 100%;'>
                    ...
                    <div style='display: inline-block; width: 100%;'>
                        ...
                        <div style="display: inline-block; width: 100%; padding-top: 10px;">
                            <p style="display: inline-block; width: 75px; padding-top: 1px; font: 10pt arial; text-align: left;">Username:</p>
                            <input size="20" style="display: inline-block; border: 1px solid #444444; font: 16px arial; width: 180px; background-color: #FFFFFF;" type="text" id="username" name="username" value="">
                        </div>
                        ...
                        <div style="display: inline-block; width: 100%; padding-top: 35px;">
                            ...
                            <p style="float: left; width: 100%; padding-top: 5px;"><a href="<?php echo base_url();?>index.php/Home/skilledprof" style="font: 10pt arial; text-decoration: underline;">Sign Up For an Account</p>
