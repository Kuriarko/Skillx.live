...
<section>
 <div class='container' style='padding-top: 25px; padding-bottom: 50px;'>
            ...
            <center>
            <form id='registrationform' name="registrationform" autocomplete="off" method="post" onsubmit="return validateform()" action="<?php echo base_url();?>index.php/Home/wc">
