...
<section align="center" class="arrange">
   <div class='container' style='min-height: 500px; padding-top: 40px; padding-bottom: 25px;'>
            ...
            <div style="display: inline-block; width: 95%; min-width: 280px; max-width: 438px;">
                ...
                <p style='display: inline-block; font-size: 40pt; font-family: oswald, arial; color: #444444;'>Company's Login</p>

                <form id="loginartist" name="loginartist" method="post" onsubmit="return validatation()" action="<?php echo base_url();?>index.php/Home/buylogin" style='display: inline-block; width: 100%;'>
                    ...
                    <div style='display: inline-block; width: 100%;'>
                        ...
                        <div style="display: inline-block; width: 100%; padding-top: 35px;">
                            ...
                            <p style="float: left; width: 100%; padding-top: 5px;"><a href="<?php echo base_url();?>index.php/Home/skillbuy" style="font: 10pt arial; text-decoration: underline;">Sign Up For an Account</p>
