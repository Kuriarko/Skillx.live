<html>
<head>
        <title> Skill Learners Registration</title>
            ...
            function validateform()
            {
			   ...
			   else if(degree.value.trim()=="")
			   {
				  alert("Please select a degree");
				   degree.style.border = "solid 3px red";
				   return false; 
			   }
