...
<html lang="en">
  ...
  <img class="img-fluid" src="<?php echo base_url(); ?>uploads/courses/<?php echo $row->thumbnail;?>" alt="Card image cap">
    ...
    <p class="card-text" style="font-family: 'Lora', serif;"><?php echo $row->description;?></p>
      <a href="<?php echo base_url();?>Home/viewmodule/<?php echo $row->course_id;?>"><button type="button" style="background-color: #4169E1; color: white; border-color: white; ">VIEW MODULES</button></a>
