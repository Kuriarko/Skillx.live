...
margin-top: 20px;
 ...
 <?php
  ...
  <div class="accordion__item js-accordion-item">
    <div class="accordion-header js-accordion-header" href="#<?php echo $r1->module_id;?>"><?= $r1->module_name ?> <i class="menu-arrow arrow_carrot-right"></i><a style="float:right; padding-bottom: 10px; overflow: hidden;" href="#" class="btn btn-info">Take Test</a></div> 
  <div class="accordion-body js-accordion-body" id="<?php echo $r1->module_id;?>">
    <div class="accordion-body__contents">
	        <?php
                   ...
                   ?>
                            <td>
                              <a href='<?php echo base_url();?>Home/fetchcontent/<?php echo $r2->content_id;?>'  ><h6><?php echo $r2->file_name;?></h6></a>
                            </td>
                        ...
                        ?> 
                            ...
                            <td>
                              <a href='<?php echo base_url();?>Home/fetchcontent/<?php echo $r2->content_id;?>' ><h6><?php echo $title;?></h6></a>
                            </td>
