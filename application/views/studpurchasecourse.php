...
<html lang="en">
  ...
  <body>
	  ...
	  <h3>Courses You May Purchase</h3>
	  ...
	  if($len == 0)
	  {
		 echo "Your course Provider has not uploaded any courses yet.";
	  }
...
<center>
    ...
    <p class="card-text" style="font-family: 'Lora', serif;"><?php echo $row->description;?></p>

    
	<a href="<?php echo base_url();?>Home/coursecheckout/<?php echo $row->course_id;?>" class="btn btn-light btn-sm active" role="button" aria-pressed="true">Buy Now</a>
	</center>
